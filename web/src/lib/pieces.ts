...
export const PIECES: Record<string, Point[]> = {
  ...
  '2x2': [{x:0,y:0},{x:1,y:0},{x:1,y:1},{x:0,y:1}],
  '3x3': [{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:0,y:1},{x:1,y:1},{x:2,y:1},{x:0,y:2},{x:1,y:2},{x:2,y:2}],
...
/** Normalize a piece so its min x and min y are both 0. */
...
/** Bounding box dimensions (1-based). */
