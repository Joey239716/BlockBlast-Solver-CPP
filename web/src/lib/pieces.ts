...
export const PIECES: Record<string, Point[]> = {
  ...
  L2:  [{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:0,y:1}], 
  L3:  [{x:0,y:0},{x:0,y:1},{x:1,y:1},{x:2,y:1}],
  L4:  [{x:0,y:1},{x:1,y:1},{x:2,y:1},{x:2,y:0}], // normalized (original minY=1)
  L5:  [{x:0,y:0},{x:0,y:1},{x:0,y:2},{x:1,y:2}],
  L6:  [{x:1,y:0},{x:1,y:1},{x:1,y:2},{x:0,y:2}],
  L8:  [{x:0,y:0},{x:1,y:0},{x:1,y:1},{x:1,y:2}],
  L7:  [{x:0,y:0},{x:0,y:1},{x:0,y:2},{x:1,y:0}],
  L9:  [{x:0,y:0},{x:0,y:1},{x:1,y:1}],
  L10:  [{x:0,y:1},{x:1,y:0},{x:1,y:1}],
  L11:  [{x:0,y:0},{x:1,y:0},{x:1,y:1}],
  L12:  [{x:0,y:0},{x:0,y:1},{x:1,y:0}],
  L13:  [{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:2,y:1},{x:2,y:2}],
  L14: [{x:0,y:0},{x:0,y:1},{x:0,y:2},{x:1,y:2},{x:2,y:2}],
  L15: [{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:0,y:1},{x:0,y:2}],
  L16: [{x:2,y:0},{x:2,y:1},{x:2,y:2},{x:1,y:2},{x:0,y:2}],
  // Rectangles
  '1x1': [{x:0,y:0}],
  '2x1': [{x:0,y:0},{x:1,y:0}],
  '1x2': [{x:0,y:0},{x:0,y:1}],
  ...
  T4: [{x:1,y:0},{x:0,y:1},{x:1,y:1},{x:2,y:1}],
  // Z-shapes
...
export const PIECE_GROUPS: { name: string; ids: string[] }[] = [
  { name: 'L-Shapes',   ids: ['L1','L2','L3','L4','L5','L6','L7','L8','L9','L10','L11','L12', 'L13','L14', 'L15','L16'] },
